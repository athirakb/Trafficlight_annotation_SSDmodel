...
def plot_origin_image(image_np, boxes, classes, scores, category_index):
    ...
    plt.savefig( 'output_images/ouput_' + 'result.png')         # plt.savefig( 'output_images/ouput_' + str(idx) +'.png')
    plt.show()
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            if red_flag:
                ...
                print('{}: stop'.format(PATH_TO_TEST_IMAGES_DIR))  # red or yellow
                commands.append(False)
            else:
                plot_origin_image(image_np, boxes, classes, scores, category_index)
                print('{}: go'.format(PATH_TO_TEST_IMAGES_DIR))
...
if __name__ == "__main__":
    ...
    Num_images = 17
    PATH_TO_TEST_IMAGES_DIR = './test_images/img_1.jpg'
    MODEL_NAME = 'model_SSD'
